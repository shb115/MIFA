...
def attack_r2(target_diff,cip, fcip, r1_keyspace,r2_keyspace):
    ...
    for group_idx in quotient_idx_list:
        ...
        for nibble_idx in nibble_idx_list:
            ...
            #print("r2_keyspace at nibble ",end='')
            #print(nibble_idx, end=':')
...
print("### 8-round key-recovery ###")

# 입력값
c1 = 0x236C2A816DB6D6A1DAA1178C97D9C27E
c2 = 0xCDC1E19735A4C51A8B1DE86D97B69158
c3 = 0xE5F08960FEFAD6BB3F9D17FB389DBC46
c4 = 0xEC7520CBED5A38890C9147724A43EF11

trail1 = [
0x00000000000000000000000000000001,
0x00000000000000000000000200000001,
0x00000808000004000000000000000101,
0x0202000A040100010200000004040001,
0x28A8000050101050220080A251514051,
0x50504D6CC0A21498B0059065E080C93B,
0x46990C4A2A4F6E09411D034D83160AA6,
0xF158FBDBC9D63821F45A1C2AB19D2460,
0xEEADCB16581213BB51BCFFE1006F5326,
]

trail2 = [
0x00000000000000000000000000000001,
0x00000008000000000000000000000001,
0x00000000040000000200000200000001,
0x00002000001014000080020200404101,
0x04100A1E0201850101094041002C0529,
0x3B068D991512528C08AAA56662551315,
0xCDB43AA10C430AFCAE9C0B610BFF5EEC,
0xAFB11A1663D1884018E4D0C4B9017317,
0x0985A9AB13A0EE32330C508972DE5357,
]

mk = 0x4CCDEDDAC09DF3E5CBB48844E64ED5C3
...
r1_keyspace = attack_r1(trail1_nibbles[7],c1_nibbles,c2_nibbles,r1_keyspace)
r1_keyspace = attack_r1(trail2_nibbles[7],c3_nibbles,c4_nibbles,r1_keyspace)
...
r2_keyspace = attack_r2(trail1_nibbles[6],c1_nibbles,c2_nibbles,r1_keyspace,r2_keyspace)
r2_keyspace = attack_r2(trail2_nibbles[6],c3_nibbles,c4_nibbles,r1_keyspace,r2_keyspace)
...
r3_keyspace = attack_r3(trail1_nibbles[5],c1_nibbles,c2_nibbles,r1_keyspace,r2_keyspace,r3_keyspace)
r3_keyspace = attack_r3(trail2_nibbles[5],c3_nibbles,c4_nibbles,r1_keyspace,r2_keyspace,r3_keyspace)
...
r4_keyspace = attack_r456(trail1_nibbles[4],c1_nibbles,c2_nibbles,r4_keyspace,4)
r4_keyspace = attack_r456(trail2_nibbles[4],c3_nibbles,c4_nibbles,r4_keyspace,4)
...
r5_keyspace = attack_r456(trail1_nibbles[3],c1_nibbles,c2_nibbles,r4_keyspace,5)
r5_keyspace = attack_r456(trail2_nibbles[3],c3_nibbles,c4_nibbles,r5_keyspace,5)
...
r6_keyspace = attack_r456(trail1_nibbles[2],c1_nibbles,c2_nibbles,r5_keyspace,6)
r6_keyspace = attack_r456(trail2_nibbles[2],c3_nibbles,c4_nibbles,r6_keyspace,6)
...
r7_keyspace = attack_r456(trail1_nibbles[1],c1_nibbles,c2_nibbles,r6_keyspace,7)
r7_keyspace = attack_r456(trail2_nibbles[1],c3_nibbles,c4_nibbles,r7_keyspace,7)
...
r8_keyspace = attack_r456(trail1_nibbles[0],c1_nibbles,c2_nibbles,r7_keyspace,8)
r8_keyspace = attack_r456(trail2_nibbles[0],c3_nibbles,c4_nibbles,r8_keyspace,8)

if (mk4_keyspace[0] not in r8_keyspace):
    print("mk not in r8_keyspace")
else:
    print("mk in r8_keyspace")
    
print("r8_keyspace length:",len(r8_keyspace))
