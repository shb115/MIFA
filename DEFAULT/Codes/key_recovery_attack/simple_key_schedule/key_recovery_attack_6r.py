...
def attack_r1(target_diff, c1, c2, r1_keyspace):
    dec_c1 = default_rc_add(c1,5)
    dec_c2 = default_rc_add(c2,5)
    ...
    for group_idx in quotient_idx_list:
        ...
        for nibble_idx in nibble_idx_list:
            ...
            for key4 in r2_keyspace[group_idx]:
                ...
                dec_cip = default_rc_add(cip,5)
                dec_fcip = default_rc_add(fcip,5)
        ...
        for nibble_idx in nibble_idx_list[group_idx_last]:
            ...
            for key in r3_keyspace[group_idx_last]:
                ...
                if(nibble_idx in [0, 1, 2, 3, 8, 9, 10, 11, 20, 21, 22, 23, 28, 29, 30, 31]):
                    ...
                    dec_cip = inv_sbox(dec_cip)
                    dec_fcip = inv_sbox(dec_fcip)
                    dec_cip = default_rc_add(dec_cip,3)
                    dec_fcip = default_rc_add(dec_fcip,3)
                    dec_cip = inv_perm(dec_cip)
                    dec_fcip = inv_perm(dec_fcip)
                    if(group_idx_last == 0):
                        if ((nibble_idx%2) == 0):
        ...
        if (target_diff[nibble_idx] != 0):
            ...
            for key in r4_keyspace:
                ...
                for r in range(round-2):
                    dec_cip = inv_sbox(dec_cip)
                    dec_fcip = inv_sbox(dec_fcip)
                    dec_cip = default_rc_add(dec_cip,4-r)
                    dec_fcip = default_rc_add(dec_fcip,4-r)
                    dec_cip = inv_perm(dec_cip)
                    dec_fcip = inv_perm(dec_fcip)
                    dec_cip = [i^j for i, j in zip(dec_cip, last_key)]
                    dec_fcip = [i^j for i, j in zip(dec_fcip, last_key)]
                ...
                dec_cip = inv_sbox(dec_cip)
                dec_fcip = inv_sbox(dec_fcip)
                dec_cip = default_rc_add(dec_cip,6-round)
                dec_fcip = default_rc_add(dec_fcip,6-round)
                dec_cip = inv_perm(dec_cip)
                dec_fcip = inv_perm(dec_fcip)
...
# 입력값
c1 = 0xE9A32E4766489E37101FB0EEA57C9BBB
c2 = 0xD16BE08B7A85BD4C1F730F714EA9CB6B
c3 = 0x899CDCB31E9ECFD1868324B48581A42E
c4 = 0x1801407DD2C1350D536C95CD002F0B89
c5 = 0x0AF3803E7B0A5B7CC203FB424EC8CB99
c6 = 0xCE67F9D0B32A80B906F05DF6F9D0F3D8
#c7 = 0xEA035934419C339C45FF4878228418B5
#c8 = 0x4DC9A28A934DEC282C930FCA41131D18
trail1 = [
0x00000000000000000000000000000002,
0x00000008000000040000000000000001,
0x00000008040400000202000000010001,
0x08A00000045050000000A02200505011,
0x30240905001004800040054240400323,
0xD2101B59E5890484480C4C5694042786,
0x38C8CECC1CCD237B0F6CBF9FEBD550D0,
]
trail2 = [
0x00000000000000000000000000000002,
0x00000000000000040000000200000001,
0x00000800000404000002000200010101,
0x00800880004144010808200A04141111,
0x021E2C1B88014251446123A1043D417B,
0x1D4EC52FD1239293A1A593614A55F562,
0x919D9CCECC5FFADCD5EFB17985AEAFA7,
]
trail3 = [
0x00000000000000000000000000000002,
0x00000000000000040000000200000001,
0x00000808000404000002000000010101,
0x0A828000044140010000002A04141011,
0x24BC0919521208D2E04106A130710153,
0xEB52535A1DFC200D3AA26A26F5D53132,
...
r1_keyspace = attack_r1(trail1_nibbles[5],c1_nibbles,c2_nibbles,r1_keyspace)
r1_keyspace = attack_r1(trail2_nibbles[5],c3_nibbles,c4_nibbles,r1_keyspace)
r1_keyspace = attack_r1(trail3_nibbles[5],c5_nibbles,c6_nibbles,r1_keyspace)
#r1_keyspace = attack_r1(trail4_nibbles[5],c7_nibbles,c8_nibbles,r1_keyspace)
...
r2_keyspace = attack_r2(trail1_nibbles[4],c1_nibbles,c2_nibbles,r1_keyspace,r2_keyspace)
r2_keyspace = attack_r2(trail2_nibbles[4],c3_nibbles,c4_nibbles,r1_keyspace,r2_keyspace)
r2_keyspace = attack_r2(trail3_nibbles[4],c5_nibbles,c6_nibbles,r1_keyspace,r2_keyspace)
#r2_keyspace = attack_r2(trail4_nibbles[4],c7_nibbles,c8_nibbles,r1_keyspace,r2_keyspace)
...
r3_keyspace = attack_r3(trail1_nibbles[3],c1_nibbles,c2_nibbles,r1_keyspace,r2_keyspace,r3_keyspace)
r3_keyspace = attack_r3(trail2_nibbles[3],c3_nibbles,c4_nibbles,r1_keyspace,r2_keyspace,r3_keyspace)
r3_keyspace = attack_r3(trail3_nibbles[3],c5_nibbles,c6_nibbles,r1_keyspace,r2_keyspace,r3_keyspace)
#3_keyspace = attack_r3(trail4_nibbles[3],c7_nibbles,c8_nibbles,r1_keyspace,r2_keyspace,r3_keyspace)
...
r4_keyspace = attack_r456(trail1_nibbles[2],c1_nibbles,c2_nibbles,r4_keyspace,4)
r4_keyspace = attack_r456(trail2_nibbles[2],c3_nibbles,c4_nibbles,r4_keyspace,4)
r4_keyspace = attack_r456(trail3_nibbles[2],c5_nibbles,c6_nibbles,r4_keyspace,4)
#r4_keyspace = attack_r456(trail4_nibbles[2],c7_nibbles,c8_nibbles,r4_keyspace,4)
...
r5_keyspace = attack_r456(trail1_nibbles[1],c1_nibbles,c2_nibbles,r4_keyspace,5)
r5_keyspace = attack_r456(trail2_nibbles[1],c3_nibbles,c4_nibbles,r5_keyspace,5)
r5_keyspace = attack_r456(trail3_nibbles[1],c5_nibbles,c6_nibbles,r5_keyspace,5)
...
r6_keyspace = attack_r456(trail1_nibbles[0],c1_nibbles,c2_nibbles,r5_keyspace,6)
r6_keyspace = attack_r456(trail2_nibbles[0],c3_nibbles,c4_nibbles,r6_keyspace,6)
r6_keyspace = attack_r456(trail3_nibbles[0],c5_nibbles,c6_nibbles,r6_keyspace,6)
#r5_keyspace = attack_r456(trail4_nibbles[1],c7_nibbles,c8_nibbles,r4_keyspace,5)
